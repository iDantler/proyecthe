<?php
// Aqui se define la ruta base del index xd
...
<body>
    ...
    <main>
        <div class="profile-container">
            <div class="user-info">
                <img src="ruta_a_tu_imagen_de_perfil.jpg" alt="Foto de perfil" class="profile-picture">
                <h1>Nombre de Usuario</h1>
                <p>Descripción o información adicional sobre el usuario.</p>
            </div>
